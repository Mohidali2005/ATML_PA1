...
TASK2_ROOT = pathlib.Path(__file__).resolve().parents[1]
PA1_ROOT = TASK2_ROOT.parent
...
def load_config(method):
    ...
    """
    with open(TASK2_ROOT/"configs"/"base.yaml") as f:
        cfg = yaml.safe_load(f)
    with open(TASK2_ROOT/"configs"/f"{method}.yaml") as f:
